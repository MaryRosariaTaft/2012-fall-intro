...
to ornaments
  ask n-of 35 patches with [pcolor = green]
    [sprout 1
      [set shape "circle"
       set color one-of [18 28 38 48 88 98 108 118 128 138]]]
...
to reds
  ask patch -7 -3 [sprout 1]
  ask patch 7 -3 [sprout 1]
  ask patch -6 -1 [sprout 1]
  ask patch 6 -1 [sprout 1]
  ask patch -5 1 [sprout 1]
  ask patch 5 1 [sprout 1]
  ask patch -4 3 [sprout 1]
  ask patch 4 3 [sprout 1]
  ask patch -3 5 [sprout 1]
  ask patch 3 5 [sprout 1]
  ask patch -2 7 [sprout 1]
  ask patch 2 7 [sprout 1]
  ask patch -1 9 [sprout 1]
  ask patch 1 9 [sprout 1]
  ask turtles
    [set shape "circle"
     set color red
     set size 1.5]
  ask patch 0 -7 [sprout 1
    [set color yellow
     set shape "star"
     set heading 0
     fd 17.5
